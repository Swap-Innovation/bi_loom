  ...
  return (
    <div className="max-w-6xl mx-auto px-5 sm:px-8 pb-16">
      ...
      <section className="animate-rise-delay-1 mb-12">
        <div className="rounded-lg border border-border bg-white px-5 sm:px-6 py-5">
          <div className="flex items-end justify-between gap-4 mb-4">
            <div>
              <p className="text-eyebrow">Portfolio progress</p>
              <p className="text-title mt-1">Across all migration projects</p>
            </div>
            <p className="text-2xl font-normal tabular-nums text-ink">
              {progress}
            ...
            {PIPELINE.map((step, i) => {
              ...
              return (
                <div key={step.key} className="min-w-0">
                  ...
                  <p className="text-xl font-normal tabular-nums text-ink pl-7">
                    {value}
                  </p>
                </div>
              );
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2.5 flex-wrap">
                      <p className="font-medium text-sm text-ink group-hover:text-primary transition-colors truncate">
                        {project.name}
                      </p>
